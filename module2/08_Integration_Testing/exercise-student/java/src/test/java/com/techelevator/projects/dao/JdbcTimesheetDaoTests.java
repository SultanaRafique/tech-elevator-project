...
public class JdbcTimesheetDaoTests extends EmployeeProjectsDaoTests {
    ...
    public void setup() {
        ...
        testTimeSheet = new Timesheet(0L, 2L, 2L, LocalDate.parse("2021-06-16"), 8.0, true, "Timesheet 5");
    }
    ...
    public void getTimesheet_returns_null_when_id_not_found() {
        Timesheet timesheet = sut.getTimesheet(98L);
    ...
    public void updated_timesheet_has_expected_values_when_retrieved()
    {
        ...
        timeSheetToUpdate.setDateWorked(LocalDate.parse("2021-08-10"));
        timeSheetToUpdate.setHoursWorked(6.0);
        timeSheetToUpdate.setBillable(false);
        timeSheetToUpdate.setDescription("updated_timeSheet");
    ...
    public void getBillableHours_returns_correct_total() {
        double expectedHour =0.0;
        double actualHour = sut.getBillableHours(2L, 2L);
        Assert.assertEquals(expectedHour, actualHour, 0);
    }

...
--SELECT genre_id FROM movie_genre WHERE movie_id = (SELECT movie_id FROM movie WHERE title = 'Memento')
--SELECT actor_id  FROM movie_actor WHERE movie_id = (SELECT movie_id FROM movie WHERE title = 'Memento')

...
*/
SELECT * FROM park;
SELECT * FROM campground WHERE campground_id = 8;
SELECT * FROM site WHERE site_id = 625;

INSERT INTO reservation(site_id, name,  from_date, to_date)
VALUES(623, 'Wayne Family', (SELECT CURRENT_DATE + INTEGER '10'), (SELECT CURRENT_DATE + INTEGER '20')),
      (624, 'arker Family', (SELECT CURRENT_DATE + INTEGER '11'), (SELECT CURRENT_DATE + INTEGER '20')),
      (625, 'Kent Family', (SELECT CURRENT_DATE + INTEGER '12'), (SELECT CURRENT_DATE + INTEGER '20'));
 ...
 */
 ...
 UPDATE reservation SET from_date = (SELECT CURRENT_DATE) , to_date = (SELECT CURRENT_DATE + INTEGER '7')

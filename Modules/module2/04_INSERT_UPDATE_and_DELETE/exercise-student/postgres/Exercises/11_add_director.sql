...
VALUES('Sultana Abdul Rafique');

UPDATE movie SET director_id =(SELECT person_id FROM person WHERE person_name ='Sultana Abdul Rafique')
WHERE title = 'The Blob';

--ROLLBACK;
--SELECT * FROM movie WHERE title = 'The Blob';
--SELECT person_id FROM person WHERE person_name = 'Sultana Abdul Rafique'

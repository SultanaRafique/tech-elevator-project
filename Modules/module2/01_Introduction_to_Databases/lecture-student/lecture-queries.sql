...
SELECT city_name, area, population FROM city WHERE area < 25 AND population > 10000;
...
SELECT state_name, population FROM state WHERE state_abbreviation = 'CA' OR state_abbreviation ='FL';
...
SELECT state_name, area, population FROM state WHERE state_abbreviation IN('CT' , 'ME' ,'MA', 'NH' , 'RI' , 'VT');
...
SELECT * FROM park;
SELECT park_name, date_established::date FROM park WHERE date_established < date '1900-01-01';

...
public class Exercises {
	...
	public boolean parrotTrouble(boolean talking, int hour) {
		boolean troubleHour = (hour < 7) || (hour > 20);
		if(talking && troubleHour){
			return true;
		}
		return false;
	}
	...
	public boolean posNeg(int a, int b, boolean negative) {
		...
		if(negative){
			...
			else if((aIsNegative && !bIsNegative) || (!aIsNegative && bIsNegative)){
				return true;
			}
		return false;
	}
	...
	public boolean icyHot(int temp1, int temp2) {
		boolean coldTemp1 = temp1 < 0;
		boolean coldTemp2 = temp2 < 0;

		boolean hotTemp1 = temp1 > 100;
		boolean hotTemp2 = temp2 > 100;

		if((coldTemp1 && hotTemp2) || (hotTemp1 && coldTemp2)){
			return true;
		}
	...
	public boolean in1020(int a, int b) {
		...
		boolean aIsIn1020 = ((a >= 10) && (a <= 20));
		boolean bIsIn1020 = ((b >= 10) && (b <= 20));

		if(aIsIn1020 || bIsIn1020 ){
			return true;
		}else{
			return false;
		}
	...
	public boolean in3050(int a, int b) {
		boolean aIsIn3040 = ((a >= 30) && (a <= 40));
		boolean bIsIn3040 = ((b >= 30) && (b <= 40));

		boolean aIsIn4050 = ((a >= 40) && (a <= 50));
		boolean bIsIn4050 = ((b >= 40) && (b <= 50));

		if((aIsIn3040 && bIsIn3040) || (aIsIn4050 && bIsIn4050)){
			return true;
		}
		return false;
	}
	...
	public boolean cigarParty(int cigars, boolean isWeekend) {
		boolean cigarIsIn4060 = ((cigars >= 40) && (cigars <= 60));
		boolean cigarsUp40 = (cigars >= 40);

		if(isWeekend ){
			if(cigarsUp40) {
				return true;
			}
		}else if(cigarIsIn4060){
			return true;
		}
		return false;
	}
	...
	public int dateFashion(int you, int date) {
		...
		boolean youStyle8 = you >= 8;
		boolean dateStyle8 = date >= 8;
		boolean youStyle2 = you <= 2;
		boolean dateStyle2 = date <= 2;

		if(youStyle2 || dateStyle2){
			return 0;
		}else{
			if(youStyle8 || dateStyle8){
				return 2;
			}else{
				return 1;
			}
	...
	public boolean squirrelPlay(int temp, boolean isSummer) {
		...
		boolean summerPlayTemp = (temp >= 60) && (temp <= 100);

		if(isSummer && summerPlayTemp){
			return true;
		}else if(playTemp){
			return true;
		}
    ...
    public String yourCakeAndEatItToo(double mealAmount, boolean isBirthday) {
    	...
    	boolean dessertIsStandard = mealAmount <= 10;
		boolean dessertIsSpecial = mealAmount <= 15;
		boolean dessertIsGinormous = mealAmount > 15;

		if(dessertIsStandard ) {
			return "standard";
		}else if(dessertIsSpecial){
			return "special";
		}else if(dessertIsGinormous) {
			return "ginormous";
		}else
			return "";
    }
	...
	public int sortaSum(int a, int b) {
		int sum = a + b;
		boolean sumIn1019 =((sum >= 10) && (sum <= 19));
		if(sumIn1019 ){
			return 20;
		}
		return sum;
	...
	public boolean in1To10(int n, boolean outsideMode) {
		boolean nIsIn110 = ((n >=1 ) && (n <= 10));
		boolean nNotIn110 = ((n <= 1) || (n >= 10));
		if(!outsideMode){
	...
	public boolean specialEleven(int n) {
		boolean nIsSpecial = ((n % 11) == 0) || ((n  % 11) == 1);
	...
	{ boolean nIsMore20 = ((n % 20) == 1) || ((n  % 20) == 2);
	...
	public boolean old35(int n) {
		boolean nIsMulti5 = (n % 5) == 0 ;
		boolean nIsMulti3 = (n % 3) == 0 ;

		if(nIsMulti5 ^ nIsMulti3){
			return true;
		}
		return false;
	}
	...
	public boolean less20(int n) {
		boolean nIsLess20 = ((n % 20) == 19) || ((n  % 20) == 18);
	...
	public boolean nearTen(int num) {
		...
		boolean numIsLessNearTen = ((num % 10) == 9) || ((num % 10) == 8);
		boolean numIsMoreNearTen = ((num % 10) == 1) || ((num % 10) == 2);
		boolean numIsMultiTen = ((num % 10) == 0);
		boolean numIsNearTen = numIsLessNearTen || numIsMoreNearTen || numIsMultiTen;
	...
	public int teaParty(int tea, int candy) {
		boolean badTeaParty = (tea < 5) || (candy <  5);
		boolean goodTeaParty = (tea >= 5) && (candy >= 5);
		boolean greatTeaParty = ((tea >= (2 * candy)) || (candy >= (2 * tea)));

		if(!badTeaParty){

			if(greatTeaParty){
				return 2;
			}else if(goodTeaParty){
				return 1;
			}
		}
		return 0;
	...
	public int loneSum(int a, int b, int c) {
		boolean aNbEqual = a == b;
		boolean bNcEqual = b == c;
		boolean aNcEqual = a == c;
		boolean aNbNcEqual = a == b && b == c && c == a;
	...
	public int luckySum(int a, int b, int c) {
		boolean aNb13 = (a == 13 && b == 13);
		boolean bNc13 = (b == 13 && c == 13);
		boolean aNc13 = (a == 13 && c == 13);
		boolean aNbNc13 = (a == 13 && b == 13 && c == 13);

		if(aNb13 || bNc13 || aNc13 || aNbNc13){

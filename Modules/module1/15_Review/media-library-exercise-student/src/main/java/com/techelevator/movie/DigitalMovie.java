...
public class DigitalMovie extends MovieMedia implements Catalogable, Streamable {
    ...
    public DigitalMovie(String studio, String asin, String mpaaRating, String director, String releaseDate, String title, String purchaseModel) {
    ...
    public String getCatalogString() {
        return String.format("Title: %s; Studio: %s; ASIN: %s; Release Date: %s; MPAA Rating: %s;" +
                "Director: %s; Media Type: %s; Formate: %s; Purchase Model: %s" ,
                getTitle(),getStudio(), getAsin(), getReleaseDate(), getMpaaRating(), getDirector(),

...
public class ExceptionsLecture {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("out of exception code");
		}
		...
		try {
			...
			System.out.println("You are overdrawn by: $" + e.getOverdraftAmount());
		}
	...
	public static void polymorphicExceptionExample() {
		...
		} catch (NumberFormatException ex) { // can catch exception with generic Exception because NumberFormatException IS an Exception
	...
	public static void mustHandleOrThrowCheckedExceptionsExample() throws OverdraftException {

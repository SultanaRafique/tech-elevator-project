...
public class CD extends MusicMedia implements Catalogable {
    ...
    public String getCatalogString() {
        return String.format("Title: %s; Artist: %s; Label: %s; ASIN: %s; Release Date: %s; Format: %s; Discs: %d",
                getTitle(), getArtist(), getLabel(), getAsin(), getReleaseDate(), getFormat(), getNumberOfDiscs());
    }
}

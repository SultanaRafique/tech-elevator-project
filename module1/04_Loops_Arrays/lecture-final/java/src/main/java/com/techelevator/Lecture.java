...
public class Lecture {
    ...
    // for loop to print numbers 1 through 10
    public void countToNumber(int maxNum) {
    ...
    public void countDownFromNumber(int number) {
//        for(int curNum = number; curNum > 0; curNum -= 10) {
        for(int curNum = number; curNum > 0; curNum--) {
...
//        return portNumbers[2];
    ...
    */
    public int returnVariableFromBlock(int number) {
        ...
        if (number > 0) { // A new block with scoped variables

...
//		lecture.countFrom10();
//
//		lecture.countToNumber(7);
//		lecture.countToNumber(3);

//		lecture.countToNumber(100);

//		lecture.print10While();

//		lecture.showDoWhile();

//		lecture.countDownFromNumber(50);

//		lecture.countDownFromNumber(25);


		int[] result = lecture.returnArray();
